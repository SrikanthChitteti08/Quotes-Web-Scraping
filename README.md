...
**Output :** The world as we have created it is a process of our thinking. It cannot be changed without changing our thinking.
...
## **Save The Quotes Dataset**
    ...
    quote = sp.find('span', class_ = 'text').text[1:-1]
    quote
**Output :** '... a mind needs books as a sword needs a whetstone, if it is to keep its edge.'
...
**Output :** '/author/George-R-R-Martin'
...
**Output :** '“A day without sunshine is like, you know, night.”'
